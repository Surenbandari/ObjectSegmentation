...
zip_file_path = '/content/drive/MyDrive/this_trail_images.zip'
...
print('number of images are' , len(os.listdir('/content/images/this_trail_images')))
...
train_data_dir = '/content/images/this_trail_images'

train_armbench = '/content/mix_tote_train_1000.json'
test_armbench = '/content/mix_tote_test_300.json'
same_obj_test_armbench = '/content/same_obj_test_300.json'
zoomed_out_test_armbench = '/content/zoomed_out_test_300.json'
...
def get_model_instance_segmentation(num_classes):
    model = torchvision.models.detection.maskrcnn_resnet50(pretrained=True)
...
"""# In this, our model failed to detect the object but it detected the tote"""
...
"""# This is a different data subset and the model has done its job"""
...
"""# Some objects are detected and other werent"""
...
"""# Failed test case whre the background is aldo been segmented as tote"""
